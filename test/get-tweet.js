suite('get-tweet', function () {
  ...
  test('initVars', function () {
    ...
    chai.assert.strictEqual(tOpts.howMany, 1);
  ...
  test('injectScript', function () {
    var scriptSrc = get_tweet.scriptElem.src,
  ...
  test('hereYouGo', function () {
    ...
    get_tweet.tweets = [0, 1, 2];
    
    get_tweet.options.callbackFn = function () {
      testVar++;
    };
  ...
  test('process', function () {
    ...
    GetTweet.process(data, get_tweet);
